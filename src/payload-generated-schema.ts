...
export const projects = pgTable(
  "projects",
  {
    ...
    size: varchar("size"),
    status: enum_projects_status("status").default("on_progress"),
    updatedAt: timestamp("updated_at", {
      mode: "string",
      withTimezone: true,
      precision: 3,
...
export const company_info = pgTable(
  "company_info",
  {
    id: serial("id").primaryKey(),
  ...
  (columns) => ({
    company_info_logo_idx: index("company_info_logo_idx").on(columns.logo),
  }),
);
...
export const relations_company_info = relations(company_info, ({ one }) => ({
  logo: one(media, {
